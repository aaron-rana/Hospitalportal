<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doctor_signup.aspx.cs" Inherits="doctor_signup" %>
...
<body>
    ...
    <div>
       <table align="center" class="style1">
            ...
            <tr>
                <td>
                    Enter Registration No:<asp:Label 
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                        ControlToValidate="txt_regno" ErrorMessage="Enter Registration no. please" 
                        ValidationGroup="ps"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" 
                        ErrorMessage="choose gender" ValidationGroup="ps" 
            ...
            <tr>
                ...
                <td class="style2">
                    <asp:DropDownList ID="dd_spec" runat="server">
                     <asp:ListItem>SELECT</asp:ListItem>
                    ...
                    <asp:ListItem>Gastroenterologists</asp:ListItem>
                    <asp:ListItem>General Physician</asp:ListItem>
                    <asp:ListItem>General Surgeon</asp:ListItem>
                    <asp:ListItem>Gynocologist</asp:ListItem>
                    <asp:ListItem>Nefrologist</asp:ListItem>
                    ...
                    <asp:ListItem>Physiologists</asp:ListItem>
                    <asp:ListItem Value="Radiologist"></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td class="style2">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
                        ControlToValidate="dd_spec" ErrorMessage="Select your Specialization please" 
                        InitialValue="SELECT" ValidationGroup="ps"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="style2">
                    Upload image:<asp:Label 
                        ID="Label14" runat="server" ForeColor="Red" Text="*"></asp:Label>
                </td>
                <td class="style2">
