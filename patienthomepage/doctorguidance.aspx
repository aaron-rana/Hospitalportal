<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="doctorguidance.aspx.cs" Inherits="patienthomepage_doctorguidance" %>
        ...
        <tr>
            <td class="style25">
                <asp:ListBox ID="ll_dept" runat="server" AutoPostBack="True" Font-Size="Large" 
                    Height="523px" Rows="12" Width="163px" 
